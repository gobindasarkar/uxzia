      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap md:flex-nowrap justify-center md:justify-start items-center gap-6">
          ...
          <div className="md:w-6/12 md:ml-auto text-center md:text-left">
            ...
            <Link
              className="min-w-[140px] px-8 h-[60px] inline-flex justify-center items-center border border-[#B8B8B8] text-center text-lg font-semibold capitalize text-white gap-x-2"
              href="/"
            >
              Start a Project
            </Link>
