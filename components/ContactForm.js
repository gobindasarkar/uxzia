  ...
  return (
    <div>
        <form action="#">
            ...
            <button className='min-w-[140px] px-8 h-[60px] inline-flex justify-center items-center border border-[#B8B8B8] text-center text-lg font-semibold capitalize text-white gap-x-2' type='submit'>Send Message</button>
        </form>
    </div>
  )
}
