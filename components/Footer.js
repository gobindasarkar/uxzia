            ...
            <div className='flex items-center justify-center md:justify-between flex-wrap gap-4'>
                <div>
                    <ul className='flex gap-x-4 items-center text-base text-[#B8B8B8]'>
                        <li><a className='transition-all hover:text-Pcolor' href='#' target='_blank'>Facebook</a></li>
                        <li><a className='transition-all hover:text-Pcolor' href='#' target='_blank'>Instagram</a></li>
                        <li><a className='transition-all hover:text-Pcolor' href='#' target='_blank'>LinkedIn</a></li>
