        ...
        <div className="container flex flex-wrap items-center justify-between mx-auto px-4">
          ...
          <div className="flex md:order-2 gap-x-4">
            <Link
              ...
              className="cursor-pointer text-white  border border-white transition-all hover:bg-white hover:text-Scolor font-semibold rounded-lg text-base md:text-lg capitalize px-4 py-1.5 text-center"
            >
              Hire me
            </Link>
            <button
